...
router.post('/project/research-design/check-complete', (req, res) => {
  req.session.data['completed-researchDesign'] = 'true'
  setFlash(req, 'completed', 'Research design and methodology')
